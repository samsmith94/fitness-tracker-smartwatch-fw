...
$(OUTPUT_DIRECTORY)/nrf52832_xxaa.out: \
  LINKER_SCRIPT  := fitness-tracker.ld

# NAGYON HASZNOS ESZKÖZ DUPLIKÁLT SOROK ELTÁVOLÍTÁSÁRA: https://www.textfixer.com/tools/remove-duplicate-lines.php
...
SRC_FILES += \
	...
	$(PROJ_DIR)/display/st7735.c \
	$(PROJ_DIR)/display/fonts.c \
	$(PROJ_DIR)/gesture/apds9960.c \
...
SDK_CONFIG_FILE := ./src/config/sdk_config.h
